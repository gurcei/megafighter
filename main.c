...
anim_detail anims[RYU_MAX] =
{
  ...
  { 0x4FA0, 960,  3, 0, 8*8, 15 },  // RYU_LPUNCH
  { 0x5AE0, 1200, 3, 1, 10*8, 15 }, // RYU_MHPUNCH
  { 0x68F0, 840,  2, 1, 7*8, 15 },  // RYU_FLPUNCH
  { 0x6F80, 960,  4, 1, 8*8, 15 },  // RYU_FMPUNCH
  { 0x7E80, 960,  4, 1, 8*8, 15 },  // RYU_FHPUNCH
};
